...
from src.schemas.models import Workflow, WorkflowDraft, WorkflowRevision
...
class WorkflowService:
    ...
    def create_workflow(self, workflow_id: UUID | None = None, owner_scope: Any = None) -> Workflow:
